...
set hls_support "$::env(HALIDE_HLS_ROOT)/apps/hardware_benchmarks/hw_support"
puts "HLS support dir: $hls_support"

open_project -reset hls_cnn_db_${app}
#open_project hls_cnn_db
set_top hls_target
add_files $hwdir/hls_target.cpp -cflags "-std=c++0x -I$libdir -I$hls_support -Wno-parentheses-equality -Wno-deprecated-register -Wno-tautological-compare"
...
add_files -tb $hwdir/hls_test.cpp -cflags "-std=c++0x -I$hwdir -I$hostdir -I$libdir -I$hls_support -Wno-parentheses-equality -Wno-deprecated-register -Wno-tautological-compare "
open_solution "test_zynq_large"
